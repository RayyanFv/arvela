        ...
        <nav className="fixed top-0 left-0 right-0 z-50 bg-background/90 backdrop-blur-md border-b border-border">
            <div className="max-w-7xl mx-auto px-6 h-16 md:h-20 flex items-center justify-between">
                ...
                <div className="hidden md:flex items-center gap-10 text-[13px] font-bold">
                    ...
                    <Link href="/portal/login" className="text-foreground/70 hover:text-primary transition-colors flex items-center gap-1.5">
                        <Users className="w-3.5 h-3.5" /> Portal Pelamar
                    </Link>
                </div>
                <div className="flex items-center gap-3 md:gap-4">
                    <Link href="/login" className="text-xs md:text-sm font-bold text-foreground/70 hover:text-foreground transition-colors">
                        Login
                    </Link>
    ...
    return (
        <footer className="bg-background border-t border-border py-20 px-6">
            <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 md:gap-20">
                ...
                <div>
                    ...
                    <div className="mt-8">
                        ...
                        <a href="mailto:hey.aicareer@gmail.com" className="text-foreground/70 hover:text-primary text-sm font-bold block transition-colors">hey.aicareer [at] gmail.com</a>
                        <p className="text-foreground/70 text-sm font-bold mt-2">arvela.id · aicareer.id</p>
                    </div>
                </div>
                <div>
                    ...
                    <div className="space-y-4">
                        ...
                        <Link href="/portal/login" className="text-foreground/70 hover:text-primary text-sm font-bold block transition-colors">Portal Pelamar / Kandidat</Link>
                        ...
                        <Link href="#" className="text-foreground/70 hover:text-primary text-sm font-bold block transition-colors">Kebijakan Privasi</Link>
                    </div>
                </div>
            </div>
            <div className="max-w-7xl mx-auto mt-20 pt-10 border-t border-border flex flex-col sm:flex-row justify-between items-center gap-4">
                <p className="text-foreground/40 text-[10px] font-black uppercase tracking-widest italic">© 2026 Arvela System by Aicareer.</p>
            </div>
