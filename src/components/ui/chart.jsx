...
// Membutuhkan: npm install recharts
// ──────────────────────────────────────────────────
"use client"
...
// Tema warna menggunakan CSS var agar sesuai design system
                            ...
                            {formatter && item?.value !== undefined && item.name ? (
                                ...
                                <>
                                    {itemConfig?.icon ? (
                                        ...
                                        !hideIndicator && (
                                            <div
                                                className={cn("shrink-0 rounded-[2px] border-(--color-border) bg-(--color-bg)", indicator === "dot" ? "h-2.5 w-2.5 rounded-full" : indicator === "line" ? "w-1" : "w-2.5")}
