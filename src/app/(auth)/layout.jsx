            ...
            <div className="w-full max-w-[1000px] bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/50 overflow-hidden flex flex-col md:flex-row relative z-10 animate-in slide-in-from-bottom-5 duration-700">
                ...
                <div className="hidden md:flex flex-col justify-between w-1/2 bg-sidebar-bg p-10 text-white relative overflow-hidden">
                    ...
                    <div className="relative z-10 flex items-center gap-3 font-bold text-3xl tracking-tight text-white">
                        <CatalystMark className="w-10 h-10" accent="fill-white" />
                        <span>Arvela<span className="text-primary">.</span></span>
                    </div>
                ...
                <div className="w-full md:w-1/2 p-8 sm:p-12 flex flex-col justify-center bg-white/50">
                    <div className="md:hidden flex flex-col items-center gap-3 mb-8">
                        <CatalystMark className="w-12 h-12" accent="fill-foreground" />
                        <div className="font-black text-2xl tracking-tight text-sidebar-bg">
                            Arvela<span className="text-primary">.</span>
                        </div>
                    </div>
                    {children}
                </div>
