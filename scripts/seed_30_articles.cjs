...
const AUTHORS = ['Dian Kusumawati', 'Hilmi Saad', 'Rayyan']

const ARTICLES = [
    // --- CATEGORY 1: HR TECH & DIGITALISASI ---
    {
        ...
        category: 'HR Tech',
        author_name: 'Hilmi Saad',
        meta_title: 'Apa Itu HRIS? Panduan Lengkap Software HR 2026',
        meta_description: 'Pelajari definisi HRIS, fungsi utama, manfaat bagi perusahaan skala kecil hingga enterprise, serta tips memilih software HR terbaik di Indonesia.',
...
Di era transformasi digital 2026, pengelolaan Sumber Daya Manusia (SDM) secara manual dengan spreadsheet atau dokumen fisik sudah jauh ketinggalan zaman. **Human Resource Information System (HRIS)** adalah platform perangkat lunak terintegrasi yang merampingkan seluruh operasional HR, mulai dari rekrutmen, absensi online GPS, pengolahan payroll, hingga evaluasi kinerja karyawan.
...
3. **Kepatuhan Hukum dan Keamanan Data**
...
- Absensi Geofencing dan Biometrik untuk mencegah kecurangan titik lokasi.
- Multi-Level Approval untuk izin, eksepsi, dan lembur secara fleksibel.
- Management Talent Pool dan ATS untuk mempercepat proses rekrutmen.
- Sistem Ujian Kompetensi dengan Proctoring AI untuk menilai kandidat secara akurat.

---

Mengadopsi HRIS modern seperti Arvela bukan sekadar modernisasi tools, melainkan investasi strategis untuk melipatgandakan produktivitas dan skalabilitas bisnis perusahaan Anda.`
    },
    {
        ...
        content: `## Pergeseran dari On-Premise ke Cloud HRIS

Banyak perusahaan merasa ragu meninggalkan sistem legacy on-premise atau Excel yang telah digunakan bertahun-tahun. Namun, pertumbuhan bisnis yang cepat membutuhkan fleksibilitas dan kecepatan akses yang hanya bisa disediakan oleh HRIS berbasis Cloud.
...
6. **Integrasi WhatsApp dan Email Notifikasi** — Komunikasi persetujuan terasa instan.
...
10. **Pengalaman Kerja Karyawan Lebih Baik** — Antarmuka modern yang intuitif dan responsif.

---

Pastikan Anda memilih penyedia HRIS yang menawarkan migrasi data massal via template Excel terstruktur seperti yang tersedia di Arvela HRMS.`
    },
    {
        ...
        meta_title: 'Tren HR Tech 2026: AI dan Otomatisasi SDM di Indonesia',
...
**1. AI Resume Screening dan Parsing**

Membaca dan memilah ribuan CV pelamar dalam hitungan detik berdasarkan kecocokan kompetensi dan skor relevansi posisi yang dilamar.

**2. Smart Proctoring Online Assessment**

Mendeteksi perpindahan tab, wajah ganda, atau pergerakan mencurigakan selama ujian kompetensi rekrutmen secara otomatis.
...
Dengan memanfaatkan platform HRIS Arvela, perusahaan Anda dapat mengakses fitur-fitur mutakhir ini untuk memenangkan kompetisi talenta di industri.`
    },
    {
        title: 'Menghitung ROI Implementasi HRIS: Apakah Layak Investasi?',
        slug: 'menghitung-roi-implementasi-hris-apakah-layak-investasi',
        category: 'Insight',
        author_name: 'Hilmi Saad',
        meta_title: 'Cara Menghitung ROI Implementasi HRIS Perusahaan',
        meta_description: 'Panduan taktis menghitung Return on Investment (ROI) sebelum membeli software HRIS untuk meyakinkan jajaran direksi perusahaan.',
...
ROI (%) = (Total Penghematan Bulanan - Biaya Langganan HRIS) / Biaya Langganan HRIS x 100%

#### Studi Kasus Perusahaan 100 Karyawan:

- **Penghematan Waktu Rekap Absensi Manual:** 25 jam/bulan x Rp 100.000/jam = Rp 2.500.000
- **Pencegahan Fraud Lembur Fiktif:** Estimasi 5% kebocoran anggaran lembur = Rp 4.000.000
...
Proses migrasi data SDM sering kali menjadi tahap paling kritis bagi Manajer HR. Kesalahan format data atau duplikasi email dapat menyebabkan kekacauan pada bulan pertama penggunaan sistem.

---

### Checklist 7 Langkah Migrasi Sukses

1. **Pembersihan Data (Data Cleansing)**: Hapus akun karyawan yang sudah resign dan nonaktif.
2. **Standarisasi Pangkat dan Golongan**: Pastikan penamaan grade sesuai struktur terpusat, contoh: Staf (STF - Level 7) hingga Direktur (DIR - Level 1).
3. **Struktur Unit Kerja (Departemen)**: Tetapkan Unit Induk dan Unit Penugasan dengan jelas.
4. **Validasi Email Unik**: Email merupakan ID login unik untuk setiap pengguna di sistem.
...
7. **Uji Coba Batch Kecil**: Lakukan tes impor 5-10 karyawan terlebih dahulu sebelum mengunggah ratusan staf sekaligus.`
    },
    {
        ...
        category: 'Compliance',
        author_name: 'Dian Kusumawati',
        meta_title: 'Keamanan Data Karyawan dan Kepatuhan UU PDP Indonesia',
...
Pengesahan UU PDP menetapkan bahwa data identitas karyawan, data medis, hingga struktur gaji adalah Data Pribadi Spesifik yang dilindungi hukum. Kebocoran data akibat penggunaan file Excel tanpa proteksi dapat memicu sanksi administratif dan denda signifikan.

---

### 3 Lapisan Proteksi Utama pada Arvela HRMS
...
**3. Enkripsi SSL/TLS dan Row Level Security (RLS)**

Data antar perusahaan terpisah total dalam tingkat arsitektur database untuk memastikan kerahasiaan penuh setiap tenant.`
    },

    // --- CATEGORY 2: REKRUTMEN & ATS ---
    {
        title: 'Panduan Menggunakan Applicant Tracking System (ATS) untuk Mempercepat Hiring 5 Kali Lebih Cepat',
        slug: 'panduan-menggunakan-ats-untuk-mempercepat-hiring-5x-lebih-cepat',
        category: 'Recruitment',
        author_name: 'Hilmi Saad',
        meta_title: 'Panduan ATS Rekrutmen: Hiring 5 Kali Lebih Cepat',
...
Menyaring ratusan email lamaran satu per satu adalah penyebab utama lamanya proses Time-to-Hire perusahaan. Applicant Tracking System (ATS) menyatukan seluruh saluran lamaran ke dalam satu papan Kanban interaktif yang mudah dikelola.
...
3. **Assessment** — Pengerjaan ujian online kompetensi atau psikotes terstruktur.
4. **Interview** — Penjadwalan wawancara live dengan tautan terintegrasi.
...
6. **Hired** — Konversi otomatis kandidat terpilih menjadi staf aktif di sistem.`
    },
    {
        ...
        category: 'Recruitment',
        author_name: 'Dian Kusumawati',
        meta_title: '7 Kesalahan Menyusun Deskripsi Lowongan Kerja',
...
Deskripsi pekerjaan yang samar atau terlalu menuntut tanpa imbalan sepadan akan menurunkan minat kandidat berkualitas tinggi untuk melamar.
...
2. **Tidak Mencantumkan Rentang Gaji** — Iklan kerja dengan transparansi gaji mendapat respon 45% lebih tinggi.
3. **Daftar Persyaratan Terlalu Panjang** — Fokus pada 5-7 kualifikasi inti yang benar-benar diperlukan.
4. **Lokasi Kerja Tidak Jelas** — Sebutkan secara pasti apakah posisi bersifat On-site, Hybrid, atau Remote.
5. **Format Tanpa Poin yang Jelas** — Gunakan bullet list agar mudah dibaca di perangkat mobile.
...
7. **Proses Lamaran Berbelit-belit** — Manfaatkan link lamaran satu klik melalui Portal Karir Arvela.`
    },
    {
        ...
        meta_description: 'Tingkatkan retensi staf baru sejak hari pertama dengan checklist otomatisasi onboarding dan penugasan mentor yang terstruktur.',
...
Mengatur jadwal wawancara antara calon karyawan dan User Manager yang sibuk sering kali memerlukan belasan kali penyesuaian email yang membuang waktu.

---

### Keunggulan Fitur Interview Arvela

- **Penjadwalan Otomatis**: Pengiriman undangan wawancara lengkap dengan tautan ruang meeting.
...
- **Rekap dan Keputusan Terpusat**: Seluruh skor tersimpan rapi pada profil pelamar tanpa risiko penilaian subjektif antar pewawancara.`
    },
    {
        ...
        meta_description: 'Bagaimana fitur proctoring otomatis mendeteksi joki ujian dan perpindahan tab pada tes asesmen penerimaan karyawan.',
...
### Fitur Anti-Cheat Proctoring Arvela

1. **Detection of Tab Switching**: Mencatat berapa kali pelamar berpindah window browser selama ujian berlangsung.
2. **Camera Snapshots Verification**: Mengambil foto berkala untuk memverifikasi wajah peserta yang mengerjakan soal.
3. **Time Limit Enforcement**: Batas waktu per soal yang ketat untuk mencegah kebocoran jawaban dari sumber luar.
4. **Skor Otomatis dan Laporan Pelanggaran**: Mengategorikan peserta dalam status Low Risk, Medium Risk, atau High Risk Violations secara transparan.`
    },

    // --- CATEGORY 3: ABSENSI & SHIFT KERJA ---
    {
        title: 'Panduan Mengatur Absensi Geofencing GPS dan Radius Kantor di Arvela HR',
        slug: 'panduan-mengatur-absensi-geofencing-gps-radius-kantor',
        category: 'Tutorial',
        author_name: 'Rayyan',
        meta_title: 'Panduan Absensi Geofencing GPS dan Radius Kantor HRMS',
        meta_description: 'Langkah mudah mengonfigurasi koordinat Latitude, Longitude, dan Radius Toleransi untuk absensi mobile staf lapangan.',
        keywords: ['absensi gps', 'geofencing hris', 'absensi radius kantor', 'aplikasi absensi mobile'],
        content: `## Mengapa Absensi GPS Penting untuk Perusahaan Hybrid dan Tim Lapangan?

Sistem absensi cetak jari (fingerprint) tradisional terbatas pada gedung fisik kantor. Di era kerja hybrid dan tim lapangan, perusahaan memerlukan Absensi Berbasis Geofencing GPS yang fleksibel.

---

### Cara Konfigurasi Radius Kantor di Arvela
...
4. Saat karyawan melakukan Clock-In atau Clock-Out dari aplikasi staf, sistem secara otomatis memvalidasi apakah koordinat HP staf berada di dalam radius resmi yang telah ditetapkan.`
    },
    {
        ...
        category: 'Insight',
        author_name: 'Hilmi Saad',
        meta_title: 'Alur 2-Stage Approval Izin, Lembur dan Resign Karyawan',
        meta_description: 'Penjelasan hirarki persetujuan 2 tingkat (Atasan Langsung ke HR Admin) untuk menjaga akuntabilitas operasional perusahaan.',
...
Persetujuan tunggal sering kali memicu konflik kepentingan atau kurangnya pengawasan dari manajer operasional yang bertanggung jawab langsung.
...
Meninjau urgensi tugas, beban kerja tim, dan ketersediaan kuota lembur atau izin staf terkait.
...
Manfaat utamanya adalah menghindari manipulasi jam kerja dan memastikan anggaran operasional perusahaan tetap terkendali dan transparan.`
    },
    {
        ...
        meta_description: 'Strategi praktis mencegah pengajuan lembur fiktif dengan batas kuota otomatis dan sistem verifikasi atasan.',
...
Pengajuan lembur yang tidak tervalidasi secara ketat dapat membengkakkan biaya operasional perusahaan hingga 20% setiap bulannya.

---

### 5 Langkah Pencegahan Fraud Lembur
...
3. **Validasi Absensi Pulang (Clock-Out Time)** — Jam lembur yang diakui tidak boleh melebihi jam fisik Clock-Out karyawan di sistem.
4. **Batas Maksimum Lembur Per Bulan** — Konfigurasi kuota maksimal lembur per individu sesuai regulasi (maksimum 18 jam/minggu).
5. **Audit Trail Rekap Lembur** — Laporan rekap harian yang dapat diunduh langsung oleh Manajer Keuangan kapan saja.`
    },
    {
        ...
        category: 'Tutorial',
        author_name: 'Rayyan',
        meta_title: 'Mengelola Hari Libur dan Kalender Kerja Multi-Cabang',
        meta_description: 'Cara mengatur tanggal merah, cuti bersama, dan hari libur lokal cabang pada platform HRIS Arvela untuk perusahaan multi-lokasi.',
...
Perusahaan dengan banyak kantor cabang, misalnya cabang Bali, Jakarta, dan Medan, memiliki variasi hari libur keagamaan daerah yang berbeda dan perlu diatur secara terpisah.
...
- **Automatic Attendance Adjustment**: Hari libur otomatis tidak mengurangi kuota jatah cuti tahunan staf yang bersangkutan.`
    },
    {
        ...
        category: 'Insight',
        author_name: 'Hilmi Saad',
        meta_title: 'Penyebab Selisih Data Absensi dan Solusi Rekap Otomatis',
        meta_description: 'Mengapa rekap absensi manual sering selisih dan bagaimana sistem otomatisasi menghilangkan rekonsiliasi akhir bulan yang melelahkan.',
...
Setiap tanggal 25, tim HR sering kali menghabiskan waktu berturut-turut untuk mencocokkan surat izin manual dengan catatan absensi fingerprint yang hilang atau tidak terdeteksi oleh mesin.

---

### Solusi Rekonsiliasi Otomatis Arvela

Dengan arsitektur terintegrasi, setiap pengajuan izin atau eksepsi yang telah disetujui otomatis mengupdate status kehadiran harian staf (Present, Sick Leave, Annual Leave, atau Overtime) secara real-time. Tidak ada lagi rekonsiliasi manual di akhir bulan yang memakan waktu.`
    },
    ...
    // --- CATEGORY 4: MANAJEMEN KINERJA & OKR ---
    {
        ...
        meta_description: 'Ulasan lengkap perbedaan Objectives & Key Results (OKR) dan Key Performance Indicators (KPI) untuk mengukur performa staf secara efektif.',
...
| Parameter | KPI | OKR |
| :--- | :--- | :--- |
| **Fokus Utama** | Mengukur hasil operasional yang sedang berjalan | Mendorong target ambisius dan inovasi |
| **Batas Waktu** | Berkelanjutan (Bulanan/Tahunan) | Berjangka pendek (Triwulanan) |
| **Tingkat Target** | 100% Harus Tercapai | Target 60-70% sudah tergolong sukses |
| **Keterkaitan Gaji** | Langsung terhubung dengan bonus | Berfokus pada pengembangan dan arah strategis |

---

Perusahaan teknologi dan startup berkembang pesat sangat cocok memanfaatkan alur OKR interaktif di Modul Performa Arvela.`
    },
    {
        ...
        meta_description: 'Cara membuat Objective dan Key Result yang terukur dan realistis untuk meningkatkan kinerja tim HR dan operasional perusahaan.',
        keywords: ['cara menyusun okr', 'target okr hr', 'performa staf', 'kpi hr'],
        content: `## Menyusun Target Ambisius yang Dapat Diukur

OKR yang efektif terdiri dari 1 Objective (Tujuan Kualitatif) dan 3-5 Key Results (Hasil Kuantitatif yang Dapat Diukur secara objektif).

---

### Contoh OKR Tim Rekrutmen Q3
...
- **Objective**: Merekrut Talenta Software Engineer Berkualitas Tinggi Secara Cepat di Q3.
  ...
  - **Key Result 2**: Meningkatkan skor kepuasan wawancara kandidat menjadi minimal 4.8 dari 5.0.
  - **Key Result 3**: Mencapai rasio pemenuhan lowongan sebesar 100% sebelum akhir kuartal.`
    },
    {
        ...
        category: 'Insight',
        author_name: 'Dian Kusumawati',
        meta_title: 'Tips Memberikan Performance Feedback Karyawan yang Efektif',
        meta_description: 'Teknik evaluasi kinerja 1-on-1 yang konstruktif untuk meningkatkan engagement dan memperbaiki performa staf tanpa mengurangi motivasi.',
        keywords: ['feedback karyawan', 'performance review', 'evaluasi 1 on 1', 'retensi talenta'],
        content: `## Seni Memberikan Masukan Konstruktif

Sesi evaluasi kinerja (Performance Review) sering kali ditakuti oleh karyawan jika penyampaian feedback terkesan menyalahkan individu secara personal.

---

### Gunakan Metode Sandwich Feedback

1. **Pujian Tulus (Praise)**: Mulai dengan mengapresiasi pencapaian dan kontribusi positif terbaru staf secara spesifik.
...
3. **Dukungan dan Solusi (Support and Plan)**: Akhiri dengan menawarkan bantuan pelatihan (LMS) dan langkah perbaikan nyata yang konkret.`
    },
    {
        ...
        meta_description: 'Langkah taktis mengatur pembobotan persentase nilai OKR, absensi, dan penilaian kompetensi pada dashboard HR Arvela.',
...
Setiap jabatan memiliki indikator keberhasilan yang berbeda. Posisi eksekutif lebih menitikberatkan pencapaian OKR strategis, sedangkan posisi operasional menitikberatkan pada kedisiplinan absensi dan kepatuhan SOP.

---

### Contoh Distribusi Pembobotan Nilai

- **Level Manager/Supervisor**: OKR (70%) + Behavioral Competency (20%) + Kedisiplinan Absensi (10%).
- **Level Pelaksana/Staf**: Kedisiplinan Absensi dan SOP (50%) + Target Tugas (40%) + Inisiatif (10%).`
    },
    {
        ...
        category: 'Insight',
        author_name: 'Rayyan',
        meta_title: 'Dampak Transparansi Target Kinerja pada Budaya Perusahaan',
        meta_description: 'Bagaimana transparansi OKR dan pencapaian target meningkatkan kolaborasi antar departemen dan menghilangkan silo organisasi.',
        keywords: ['transparansi okr', 'budaya kerja', 'engagement karyawan', 'hr strategy'],
        content: `## Menghilangkan Silo Antar Departemen

Ketika setiap divisi bekerja sendiri tanpa mengetahui sasaran utama perusahaan, akan terjadi tumpang tindih prioritas yang dikenal sebagai silo mentality.
...
- **Akuntabilitas Terukur**: Setiap anggota tim dapat memantau kemajuan pengerjaan OKR mereka secara objektif di platform Arvela.`
    },

    // --- CATEGORY 5: COMPLIANCE & OFFBOARDING ---
    {
        ...
        category: 'Compliance',
        author_name: 'Hilmi Saad',
        meta_title: 'Prosedur Offboarding dan Resign Sesuai UU Cipta Kerja',
        meta_description: 'Panduan hukum mengurus pengunduran diri karyawan, hak uang pisah, serah terima aset, dan surat keterangan kerja (paklaring).',
        keywords: ['offboarding karyawan', 'resign uu cipta kerja', 'uang pisah resign', 'paklaring kerja'],
        content: `## Menangani Pengunduran Diri Karyawan Secara Profesional dan Sesuai Hukum
...
2. Bebas Dari Ikatan Dinas atau Kewajiban Pelatihan yang Belum Selesai.
3. Melakukan Serah Terima Aset dan Pekerjaan (Handover Progress) kepada pengganti.
4. Persetujuan Manajemen via Alur Offboarding Resmi di sistem.

Modul Offboarding Arvela memfasilitasi checklist penyerahan laptop atau aset kantor, penandatanganan surat bebas tanggungan, hingga penerbitan Surat Keterangan Kerja (Paklaring) otomatis.`
    },
    {
        ...
        category: 'Compliance',
        author_name: 'Dian Kusumawati',
        meta_title: 'Cara Menghitung Uang Kompensasi PKWT dan Pesangon',
        meta_description: 'Rumus resmi perhitungan uang kompensasi karyawan kontrak PKWT sesuai PP No. 35 Tahun 2021 yang berlaku saat ini.',
...
Kompensasi = (6 / 12) x Rp 6.000.000 = Rp 3.000.000`
    ...
    {
        title: 'Checklist Serah Terima Aset Kantor Saat Karyawan Resign',
        ...
        meta_description: 'Daftar pengembalian inventaris perusahaan (laptop, kartu akses, akun email) untuk mencegah kerugian aset saat karyawan keluar.',
...
Kerugian terbesar perusahaan saat karyawan keluar sering kali berupa akun email atau laptop kantor yang belum di-reset dan diamankan dengan benar.
...
- **Fisik dan Keamanan**: Kartu akses gedung (ID Card), kunci loker, dan kendaraan dinas.
- **Aset Digital**: Penonaktifan akun email perusahaan, akses Google Drive, dan pencabutan hak akses sistem HRIS.
- **File Pekerjaan**: Pemindahan kepemilikan dokumen penting ke akun Direct Manager yang baru.`
    },
    {
        ...
        category: 'Insight',
        author_name: 'Hilmi Saad',
        meta_title: 'Pentingnya Exit Interview untuk Mengungkap Alasan Resign',
        meta_description: 'Cara melakukan wawancara keluar (exit interview) yang jujur untuk memperbaiki manajemen dan membangun kultur kerja yang lebih sehat.',
...
Alasan "ingin mencari tantangan baru" di surat pengunduran diri sering kali hanya pemanis. Melalui Exit Interview yang terstruktur, HR dapat menggali akar permasalahan sebenarnya, misalnya masalah kepemimpinan atasan, beban kerja berlebih, atau ketidaksesuaian kompensasi.
...
3. Apa saran terbaik Anda untuk perbaikan tim ini di masa mendatang?
4. Apakah Anda akan merekomendasikan perusahaan ini kepada rekan Anda? Jelaskan alasannya.`
    },
    {
        ...
        meta_description: 'Cara menerbitkan surat paklaring digital resmi dengan nomor surat otomatis dan tanda tangan digital di sistem Arvela HRMS.',
        keywords: ['surat paklaring', 'surat keterangan kerja', 'offboarding hris', 'template paklaring'],
        content: `## Penerbitan Surat Paklaring Tanpa Proses Cetak Ulang

Surat Keterangan Kerja (Paklaring) dibutuhkan oleh mantan karyawan untuk klaim BPJS Ketenagakerjaan maupun melamar pekerjaan baru di perusahaan lain.

---

### Fitur Otomatisasi Paklaring Arvela

- **Penomoran Surat Otomatis**: Sesuai format penomoran arsip resmi perusahaan yang telah dikonfigurasi.
- **Auto-Fill Data Staf**: Nama lengkap, NIP, Jabatan Terakhir, dan Masa Kerja otomatis terisi presisi dari database.
- **Tanda Tangan Digital HR Admin atau Owner**: Dokumen siap diunduh dalam format PDF resmi yang sah secara administratif.`
    },
    ...
    // --- CATEGORY 6: LMS & TRAINING ---
    {
        ...
        meta_description: 'Tingkatkan keterampilan dan kompetensi karyawan dengan sistem pembelajaran LMS internal yang terintegrasi penuh ke HRIS.',
...
Perusahaan yang berinvestasi dalam pengembangan skill staf mengalami margin keuntungan 24% lebih tinggi dibandingkan perusahaan yang tidak memiliki program pelatihan terstruktur.

---

### Keunggulan LMS Terintegrasi di Arvela

- **Katalog Kursus Kustom**: Unggah materi pembelajaran berbasis modul, PDF, atau video tutorial internal perusahaan.
- **Kuis dan Sertifikat Otomatis**: Karyawan yang lulus evaluasi ujian akhir kursus otomatis menerima Sertifikat Kelulusan Digital.
- **Pelacakan Progress Real-Time**: Manajer dapat memantau persentase penyelesaian kursus setiap anggota tim kapan saja.`
    },
    {
        ...
        category: 'Insight',
        author_name: 'Hilmi Saad',
        meta_title: 'Strategi Upskilling dan Reskilling Karyawan di Era AI',
        meta_description: 'Cara merancang program pelatihan pengembangan skill staf agar tetap relevan dan kompetitif di tengah perkembangan teknologi digital.',
        keywords: ['upskilling karyawan', 'reskilling staf', 'pelatihan ai', 'hr development'],
        content: `## Menyiapkan Tenaga Kerja yang Adaptif

Perkembangan teknologi membutuhkan adaptasi keterampilan baru (upskilling) dan pengalihan peran staf ke bidang yang lebih berorientasi pada pemikiran kritis dan analitis (reskilling).

---

### 3 Langkah Implementasi Upskilling yang Efektif

1. **Skill Gap Analysis**: Identifikasi ketimpangan kemampuan staf melalui tes evaluasi di modul Asesmen Arvela.
2. **Personalized Learning Path**: Tugaskan modul kursus LMS yang sesuai dengan kekurangan skill individu secara otomatis.
3. **Praktek dan Evaluasi OKR**: Terapkan skill baru dalam proyek nyata yang terukur di target triwulanan perusahaan.`
    },
    {
        ...
        meta_description: 'Panduan menerbitkan sertifikat kelulusan modul pelatihan karyawan lengkap dengan kode verifikasi unik dan desain profesional.',
        keywords: ['sertifikat digital', 'sertifikat lms', 'pelatihan staf', 'arvela lms'],
        content: `## Pengakuan Atas Pencapaian Pembelajaran Staf

Sertifikat pelatihan memberikan pengakuan formal dan motivasi ekstrinsik bagi karyawan yang berhasil menyelesaikan modul pengembangan diri dengan hasil yang baik.

---

### Fitur Sertifikat Otomatis Arvela LMS

- **Syarat Kelulusan Kustom**: Ditentukan berdasarkan skor minimal ujian yang bisa disesuaikan (misalnya minimum 80 dari 100).
- **Desain Template Profesional**: Menggunakan header logo resmi perusahaan dan nama staf tercetak secara otomatis.
- **Verification URL Unique**: Setiap sertifikat dilengkapi dengan tautan verifikasi keabsahan dokumen yang dapat diperiksa kapan saja.`
    },
    {
        ...
        meta_description: 'Gunakan evaluasi model Kirkpatrick untuk mengukur dampak pelatihan terhadap kinerja dan produktivitas staf secara komprehensif.',
        keywords: ['efektivitas pelatihan', 'evaluasi kirkpatrick', 'roi pelatihan', 'hr metric'],
        content: `## Menilai Keberhasilan Program Training Secara Objektif

Mengadakan pelatihan tanpa mengukur efektivitasnya secara terstruktur sama saja dengan membuang anggaran tanpa mengetahui hasilnya.

---

### 4 Tingkatan Evaluasi Model Kirkpatrick

1. **Reaction (Reaksi)**: Kepuasan staf terhadap materi dan pembawaan trainer pasca pelatihan.
...
4. **Results (Hasil Bisnis)**: Penurunan tingkat kesalahan kerja (error rate) dan peningkatan output tim secara keseluruhan.`
    }
]
...
async function seedArticles() {
    ...
    for (let i = 0; i < ARTICLES.length; i++) {
        ...
        if (error) {
            console.error(`[${i + 1}/30] FAILED: ${art.slug} — ${error.message}`)
            skippedCount++
        } else {
            console.log(`[${i + 1}/30] Seeded: ${art.title}`)
            insertedCount++
        }
    }

    console.log(`\nSeeding completed. ${insertedCount} articles inserted/updated, ${skippedCount} failed.`)
}
